...
class PageFactoryTest extends \PHPUnit_Framework_TestCase
{
    public function testDetectFactoryPage()
    {
        ...
        $this->assertInstanceOf('Laminas\\Navigation\\Page\\Uri', AbstractPage::factory(array(
            'label' => 'URI Page',
            'factory_uri' => '#'
        )));

        $this->assertInstanceOf('Laminas\\Navigation\\Page\\Mvc', AbstractPage::factory(array(
            'label' => 'URI Page',
            'factory_mvc' => '#'
        )));
    }
